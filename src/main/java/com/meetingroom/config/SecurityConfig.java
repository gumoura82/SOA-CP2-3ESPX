    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/salas/**").authenticated()
                .requestMatchers(HttpMethod.PUT, "/api/salas/**").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/api/salas/**").authenticated()
